...
export default function ContactFinal() {
  return (
    <section id="kontakt" className="luxury-section bg-luxury-white py-20 md:py-44">
      <div className="container mx-auto max-w-[1400px] px-6 md:px-12">
        ...
        <div className="mt-12 grid gap-6 md:mt-16 lg:grid-cols-[0.85fr_1.15fr]">
            ...
            {contacts.map((contact, index) => {
              ...
              return (
                <Reveal key={contact.label} delay={index * 0.08}>
                  <div className="luxury-card flex items-center gap-4 p-5 md:gap-5">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center bg-accent text-white">
                      <Icon size={20} strokeWidth={1.7} />
                    </div>
                    <div className="min-w-0">
                      <div className="font-mono text-[10px] uppercase tracking-[0.25em] text-label">
                        {contact.label}
                      </div>
                      <div className="mt-1 break-words font-serif text-2xl italic tracking-[-0.04em] md:text-3xl">
                        {contact.value}
                      </div>
                      <div className="mt-1 text-sm text-body/65">{contact.sub}</div>
                    </div>
                  </div>
                </Reveal>
              );
          ...
          <Reveal delay={0.16}>
            <div className="luxury-card h-[320px] overflow-hidden md:h-[420px]">
              <iframe
        ...
        <Reveal delay={0.22}>
          <p className="mt-8 font-mono text-[10px] uppercase tracking-[0.3em] text-label">
