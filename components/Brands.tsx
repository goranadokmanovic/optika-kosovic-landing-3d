...
export default function Brands() {
  return (
    <section id="brendovi" className="bg-background py-20 md:py-44">
      ...
      <motion.div
        ...
        className="relative mt-12 overflow-hidden border-y border-white/8 py-6 md:mt-16 md:py-8"
      >
        ...
        >
          {[...brands, ...brands].map((brand, index) => (
            <span
              key={`${brand}-${index}`}
              className="font-mono text-3xl uppercase tracking-[0.2em] text-white/18 md:text-7xl md:tracking-[0.25em]"
            >
              {brand}
